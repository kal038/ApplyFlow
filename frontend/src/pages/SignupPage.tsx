      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="w-full max-w-sm space-y-8 rounded-md border bg-background p-6 shadow-md">
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">Get started with ApplyFlow</p>
          </div>

          <form onSubmit={handleSignup} className="space-y-4 rounded-md border p-6">
            ...
            <div className="space-y-2">
              ...
              />
              {showPasswordError && <p className="text-sm text-red-500">Passwords do not match</p>}
            </div>
