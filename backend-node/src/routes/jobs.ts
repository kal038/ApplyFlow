...
import { getAllJobs, createJob, updateJob, deleteJob } from '@/controllers/jobsController';
...
router.put('/:job_id', authenticateJWT, checkStaleJob(true), validateUpdateJob, updateJob);
router.delete('/:job_id', authenticateJWT, checkStaleJob(true), deleteJob);
